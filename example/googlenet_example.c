...
int main(int argc, char **argv)
{
	...
	NET_ADD_INCEPTION_V1(n, TRAIN_SGD, 10, 192, 7, 7, 7, 7, 64, 96, 128, 16, 32, 32);
	...
	cvInitMatHeader(&M[7], 10 * 7, 7, CV_32FC1, n->layer[7]->out.val, 7 * sizeof(data_val_t));
	cvNamedWindow("inception", CV_WINDOW_AUTOSIZE);
#endif
